"""
Django settings for derty_dev_53036 project.
...
ROOT_URLCONF = 'derty_dev_53036.urls'
...
WSGI_APPLICATION = 'derty_dev_53036.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "derty_dev_53036 API",
    "DESCRIPTION": "API documentation for derty_dev_53036 App",
    "VERSION": "v1",
}
